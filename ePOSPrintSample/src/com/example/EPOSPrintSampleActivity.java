...
public class EPOSPrintSampleActivity extends Activity implements OnClickListener, StatusChangeEventListener, BatteryStatusChangeEventListener {
    ...
    String openDeviceName = "10.0.0.191";
    ...
    static void setPrinter(Print obj){
        System.out.println(">> static void setPrinter(Print obj)...");
    	printer = obj;
    }

    static Print getPrinter(){
        System.out.println(">> static Print getPrinter()...");
    	return printer;        
    }

    static void closePrinter(){
        System.out.println(">> static void closePrinter()...");    	
        try{
